    ...
    <PageLoader>
      <main className="bg-[#0b0b0b] text-primary transition-colors duration-300 lg:px-0">
        ...
        <section className="py-20 px-3 md:px-4 lg:px-8 bg-[#0b0b0b]">
          <div className="max-w-full mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
              <div className="text-4xl md:text-5xl lg:text-[36px] text-white tracking-tighter font-medium">
                Studio Story
              </div>
        ...
        <section ref={valuesRef} className="py-20 px-3 md:px-4 lg:px-8 bg-[#0b0b0b] border-t border-white/30">
          <div className="max-w-full mx-auto">
            <h2 className="text-4xl md:text-5xl lg:text-[36px] text-white tracking-tighter font-medium mb-16">
              Our Values
            </h2>
              ...
              {[
                {
                  ...
                  image: "https://yzxbaoljj9kxd7ea.public.blob.vercel-storage.com/Sabbir-02.jpg",
                },
                {
                  name: "Marcus Johnson",
                  role: "Lead Designer",
                ...
                >
                  ...
                  <h3 className="text-2xl text-white font-medium mb-1">{member.name}</h3>
        ...
        <section className="py-20 px-3 md:px-4 lg:px-8 bg-[#0b0b0b] border-t border-white/30">
          <div className="max-w-full mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
              ...
              >
                <Image
                  src="https://0jvrxjmlupwyw6gl.public.blob.vercel-storage.com/Logo%20sckatch.png"
        ...
        <section className="relative py-20 px-3 md:px-4 lg:px-8 bg-[#0b0b0b]">
          ...
          <div className="max-w-full mx-auto pt-16">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
              ...
              >
                <Image
                  src="https://8e11cn5owx5zj8yl.public.blob.vercel-storage.com/adnan%20akif.jpg"
